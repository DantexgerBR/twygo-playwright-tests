...
# ID da atividade pré-cadastrada na org de teste.
# Defina no .env como ATIVIDADE_VIDEO_MARCA_DAGUA_ID, ou ajuste aqui.
ATIVIDADE_ID = os.environ.get("ATIVIDADE_VIDEO_MARCA_DAGUA_ID", "TODO-id-da-atividade")
...
def test_desmarcar_marca_dagua_oculta_no_aprender(
    ...
    admin_page.abrir_edicao(base_url, ATIVIDADE_ID)
    expect(admin_page.checkbox_marca_dagua).to_be_checked()
    ...
    expect(admin_page.checkbox_marca_dagua).not_to_be_checked()
    ...
    aprender.abrir_atividade(base_url, ATIVIDADE_ID)
